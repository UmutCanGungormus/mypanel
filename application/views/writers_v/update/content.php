    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("writers/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Ad Soyad</label>
                        <input class="form-control" placeholder="Ad Soyad" name="name" value="<?php echo $item->name; ?>">
                    ...
                    <div class="form-group">
                        <label>Görev</label>
                        <input class="form-control" placeholder="Görev" name="type" value="<?php echo $item->type; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        <label>E-Mail</label>
                        <input class="form-control" placeholder="E-Mail" type="email" name="email" value="<?php echo $item->email; ?>">
                        <?php if(isset($form_error)){ ?>
