...
<div class="simple-page-wrap">
    <div class="simple-page-logo animated swing">
        <a href="index.html">
            <span><img src="<?php echo base_url("uploads/site/logo.png")?>" alt="Mutfak Yapım"></span>
        </a>
    </div>
    <div class="simple-page-form animated flipInY" id="login-form">
        <h4 class="form-title m-b-xl text-center">Bilgilerinizle Panele giriş Yapın</h4>
        <form action="<?php echo base_url("userop/do_login"); ?>" method="post">
            ...
            <button type="submit" class=" login-btn btn text-white">Giriş Yap</button>
        </form>
    </div>
