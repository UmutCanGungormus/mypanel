...
class Product extends MY_Controller
{
        ...
        foreach ($items as $item) {
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a class="dropdown-item" href="' . base_url("product/update_form/$item->id") . '">Kaydı Düzenle</a></li>
                    <li><a class="dropdown-item" href="' . base_url("product/delete/$item->id") . '">Kaydı Sil</a></li>
                </ul>
            </div>';
            ...
            $data[] = array($item->product_rank, '<i class="fa fa-arrows" data-id="' . $item->id . '"></i>',$item->id, $item->product_title, $item->category_title, '<input type="checkbox" class="js-switch" '.($item->isActive == 1 ? "checked" : null).' data-switchery="true"/>', $proccessing);
        }
    ...
    public function save()
    {
        ...
        if ($validate) {
            $getRank = $this->product_model->get([],"products.rank DESC");
    ...
    public function rankSetter()
    {
        ...
        $rank = $this->input->post("toPosition")+1;
