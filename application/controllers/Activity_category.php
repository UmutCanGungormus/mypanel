<?php
class Activity_category extends MY_Controller{
    public $viewFolder = "";
    public function __construct(){
        parent::__construct();
        $this->viewFolder = "activity_category_v";
    ...
    public function save(){
        ...
        if($validate){
            ...
            redirect(base_url("activity_category"));
        } else {
            $viewData = new stdClass();
            $viewData->viewFolder = $this->viewFolder;
            $viewData->subViewFolder = "add";
    ...
    public function update($id){
        ...
        if($validate){
            ...
            $viewData->subViewFolder = "update";
            $viewData->form_error = true;
            $viewData->item = $this->activity_category_model->get(
                array(
                    "id"    => $id,
                )
            );
    ...
    public function delete($id){
        $delete = $this->activity_category_model->delete(
            array(
                "id"    => $id
            )
        );
