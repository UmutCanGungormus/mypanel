...
class Product_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->column_order = array('product_rank', 'products.id','products.id', 'products.title', 'product_categories.title', 'products.isActive');
        // Set searchable column fields
        $this->column_search = array('product_rank', 'products.id','products.id', 'products.title', 'product_categories.title', 'products.isActive');
        // Set default order
